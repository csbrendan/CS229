...
def train_model_with_gradual_unfreezing(cfg_path, ckpt_path, real_dir, fake_dir, output_dir, total_epochs=7):
    ...
    train_dataset = DeepfakeDataset(real_dir, fake_dir, clip_size=32, max_videos=40)
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        if val_metrics['accuracy'] > best_val_acc:
            ...
            model_save_path = os.path.join(output_dir, f'best_zoom_model_acc_{best_val_acc:.4f}.pth')
            torch.save({
                'epoch': epoch,
