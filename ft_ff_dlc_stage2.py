...
def train_model(cfg_path, ckpt_path, real_dir, fake_dir, output_dir, num_epochs=10):
    ...
    train_dataset = DeepfakeDataset(real_dir, fake_dir, clip_size=cfg.clip_size, max_videos=100, save_samples=False, sample_dir=sample_dir)
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 2 == 0:
            checkpoint_path = os.path.join(output_dir, f'stage2_checkpoint_epoch_{epoch}.pth')
            torch.save({
                'epoch': epoch,
...
if __name__ == "__main__":
    ...
    real_dir = "/home/azureuser/AltFreezing/examples/dlc_self_ff/dlc_trimmed"
    fake_dir = "/home/azureuser/AltFreezing/examples/dlc_self_ff/dlc_processed"
