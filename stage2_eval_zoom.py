...
real_dir = "/home/azureuser/AltFreezing/examples/zoom_dataset/all/real"
fake_dir = "/home/azureuser/AltFreezing/examples/zoom_dataset/all/fake"
...
if __name__ == "__main__":
    ...
    json_filename = os.path.join(out_dir, f'results_stage2_zoom_thresh_pt1_{timestamp}.json')
